...
function Amorder() {
  ...
  useEffect(() => {
    ...
    fetchData(import.meta.env.VITE_API + "payment/getpayments", setPayments, 'payment');
    fetchData(import.meta.env.VITE_API + "auth/amorder", setOrders);
  }, []);
  ...
  const updatePaymentStatus = async (paymentId, status) => {
    try {
      ...
      const response = await axios.put(
        import.meta.env.VITE_API + "payment/putstatuspayments",
        { paymentId, status },
        { headers: { Authorization: `Bearer ${token}` } }
      );
